...
(function(root, factory) {
  ...
  var document = window.document,
    defaults = {
      ...
      locale: {
        buttons: {
          prev: '<i class="icon-arrow_back calendar-arrows"></i>',
          next: '<i class="icon-arrow_forward calendar-arrows"></i>',
          close: '&times;',
          reset: 'ОЧИСТИТЬ',
          apply: 'ПРИМЕНИТЬ'
        },
    ...
    renderTopButtons = function(opts, monthTitleHtml) {
      return (
        '<div class="lightpick__toolbar">' +
        '' +
        '<button type="button" class="lightpick__previous-action">' +
        opts.locale.buttons.prev +
        '</button>' + monthTitleHtml +
        '<button type="button" class="lightpick__next-action">' +
        opts.locale.buttons.next +
        '</button>' +
        (!opts.autoclose && !opts.inline && false
    ...
    renderCalendar = function(el, opts) {
      ...
      for (var i = 0; i < opts.numberOfMonths; i++) {
        ...
        if (opts.numberOfMonths === 1) {
          html += renderTopButtons(opts, monthTitleHtml);
        }
